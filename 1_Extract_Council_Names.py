...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov 11 15:46:00 2024
...
with open('reformatted_council_names_US.csv', mode='w', encoding='utf-8', newline='') as file:
...
print("Reformatted council names have been written to reformatted_council_names_US.csv with not found flags where applicable.")
